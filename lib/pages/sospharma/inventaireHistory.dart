                  ...
                  builder: (context, dataSnapshot) {
                    if (dataSnapshot.connectionState == ConnectionState.waiting) {
                      ...
                      dataSnapshot.data.docs.forEach((result) {
                        ...
                        InventaireLigne(name, barCode, stock, newStock,expdate, myTime, docId, prixAchat, userName);
...
//                     String prixAchat = result["prixAchat"];
//                     InventaireLigne vente =
//                         InventaireLigne(name, barCode, stock, newStock,expdate, myTime, result.id, prixAchat, userName);
//                     inventaires.add(vente);
//                     if(prixAchat != null){
//                       totalNew = totalNew + (int.parse(prixAchat
//                           .replaceAll(new RegExp(r"\s+"), "")) * int.parse(newStock.replaceAll(new RegExp(r"\s+"), "")));
