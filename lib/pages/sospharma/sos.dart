...
import 'package:expopharma/pages/sospharma/data.dart';
          ...
          appBar: AppBar(
            ...
            actions: <Widget>[
              IconButton(
                ...
                onPressed: () {
                  ListVenteSos myList = new ListVenteSos(listVentes, null, null);

                  fireStoreInstance.collection("ventesSos").add({
                    //'ventes': myList.toMap(),
                    'ventesos': listVentes.map((i) => i.toMap()).toList(),
          ...
          actions: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () {
                ...
                if (value != 0) {
                  listVentes.add(new VenteSos(item, value));
